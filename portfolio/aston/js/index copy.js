...
function scrollEvent(){
    $(window).on("wheel", function(e) {
        ...
        function page3(page){
            ...
            // console.log(wMin)
            // console.log(wMax)
            // section3.classList.add("min")
                // console.log("PageIdx : " + (page))
                // let posStart = "900px";

                // let left = 1
                // let posStart = ((left) * $(window).width());
                // let widz = $(window).width()
                // if(mHtml.is(":animated")) return;
                ...
                //     left = 1;
                // } 
                // mHtml.animate({scrollLeft : posStart},0);
                ...
                //     setTimeout(()=>{
                //         section3.classList.add("max")
                //         section3.classList.remove("min")
                //     },850)
                //     if(section3.classList.contains("max")){
                //         page++
                //         // if(page>3) return
                //         return
                //     }
                ...
                //     setTimeout(()=>{
                //         section3.classList.remove("max")
                //         section3.classList.add("min")
                //     },850)
                //     if(section3.classList.contains("min")){
                //         page--
                //         return
                //     }
                // }
